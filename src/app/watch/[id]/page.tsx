...
//     const isOwnListing = session?.user?.id === watch.ownerId;
//     const isSoldOut = (watch.quantity ?? 0) <= 0;
...
//             `Confirm purchase of ${buyQuantity} x ${watch!.title} for $${(watch!.price * buyQuantity).toLocaleString()}?`
//         );
//         if (!confirmed) return;
...
//             setWatch({ ...watch!, quantity: watch!.quantity - buyQuantity });
//             setBuyQuantity(1);
//         } catch (err) {
...
//                                         −
//                                     </button>
//                                     <span className="font-body text-ivory w-6 text-center">{buyQuantity}</span>
//                                     <button
//                                         onClick={() => setBuyQuantity((q) => Math.min(watch.quantity, q + 1))}
//                                         className="w-8 h-8 border border-gold/30 rounded-sm text-gold hover:bg-gold/10 transition-colors"
//                                     >
//                                         +
//                                     </button>
...
//                             >
//                                 {buying ? "Processing..." : `Buy Now — $${(watch.price * buyQuantity).toLocaleString()}`}
//                             </button>
//                         </>
//                     )}
